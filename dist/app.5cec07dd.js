...
},{}],"src/core/veiw.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  Api.prototype.reqeust = function () {
...
var veiw_1 = __importDefault(require("../core/veiw"));
      ...
      return __awaiter(_this, void 0, Promise, function () {
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            ...
            case 1:
              _a = _b.sent();
              title = data.title, content = data.content, comments = data.comments;
...
},{"../core/veiw":"src/core/veiw.ts","../core/api":"src/core/api.ts","../config":"src/config.ts"}],"src/page/news-feed-view.ts":[function(require,module,exports) {
"use strict";
...
},{"../core/veiw":"src/core/veiw.ts","../core/api":"src/core/api.ts","../config":"src/config.ts"}],"src/page/index.ts":[function(require,module,exports) {
"use strict";
